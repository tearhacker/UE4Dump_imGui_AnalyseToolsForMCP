...
{
    constexpr uintptr_t ObjObjects = 0x20;
}

namespace TUObjectArray
{
    constexpr uintptr_t Objects = 0x20;
...
namespace UClass
{
    constexpr uintptr_t ClassDefaultObject = 0x0;
    constexpr uintptr_t ImplementedInterfaces = 0x0;
    constexpr uintptr_t CastFlags = 0x0;
    constexpr uintptr_t ClassFlags = 0x0;
}
...
namespace ULevel
{
    constexpr uintptr_t Actors = 0x0;
}

namespace UDataTable
{
    constexpr uintptr_t RowMap = 0x0;
}
...
{
    constexpr uintptr_t Names = 0x9efc670;
    constexpr uintptr_t UObjectArray = 0x9f062a0;
    constexpr uintptr_t ObjObjects = 0x9f062c0;
    constexpr uintptr_t Engine = 0x0;
    constexpr uintptr_t World = 0x0;
    constexpr uintptr_t Matrix = 0xb3e0740;
    constexpr uintptr_t Physx = 0xb476f20;
    constexpr uintptr_t FrameCount = 0xb3e62d0;
    constexpr uintptr_t StaticFindObject = 0x6deb7b8;
    constexpr uintptr_t NativeAndroidApp = 0xb00a070;
