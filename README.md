...
```
1. overview.md              → 全貌概览
2. 泪心UE4_imGui_AnalyseToolsForMCp功能说明.md   → 做什么、为什么
3. 泪心UE4_imGui_AnalyseToolsForMCp开发必读架构.md → 怎么写、规范
4. MCP可用工具文档.md       → 43~47 工具规格速查
5. mcp-protocol.md         → 两端 wire protocol
6. docs/api/00-索引.md     → 设备端 15 模块 API 精读索引
7. UMT_改动代码文档.md      → MCP 版 vs 原始版改动清单
8. 先行开发修正文档手册.md   → 已知问题与修正方向（2026-09-01）
```
