...
private:
    ...
    static void AppendOffsetsToBuffer(std::vector<Struct> &arr, class BufferFmt *bufFmt);
...
public:
    ...
    bool AppendToBuffers(class BufferFmt *enumsBufFmt, class BufferFmt *structsBufFmt, class BufferFmt *classesBufFmt);
    bool AppendOffsetsToBuffer(class BufferFmt *offsetBufFmt);
};
