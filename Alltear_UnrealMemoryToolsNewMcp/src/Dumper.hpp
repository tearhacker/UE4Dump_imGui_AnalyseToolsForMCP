...
private:
    ...
    void DumpAIOHeader(BufferFmt &logsBufferFmt, BufferFmt &aioBufferFmt, BufferFmt &enumsBufferFmt, BufferFmt &structsBufferFmt, BufferFmt &classesBufferFmt, BufferFmt &offsetBufferFmt, UEPackagesArray &packages, const ProgressCallback &progressCallback);
};
